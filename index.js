...
/////////////////
const BotName = 'AsterixSty BOT🤖'; 
const instagram = 'https://instagram.com/hennmln'; 
const telegram = 'https://t.me/AsterixSty'; 
const kapanbotaktif = 'KETIKA HANYA DIAKTIFKAN'; 
const youtube = 'https://www.youtube.com/channel/UCa7flVt5SDV1rC6Nc5Ltgmw';
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:@hennmln')
